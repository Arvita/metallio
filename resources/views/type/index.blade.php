                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <button data-url="{{ route('type.create') }}"
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="type" class="display table table-striped table-hover">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>Name</th>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('div.dataTables_filter input').unbind().bind('keyup', function(e) {
                if (e.keyCode == 13) {
                    type.fnFilter(this.value);
                } else {
                    if (this.value.length == 0) type.fnFilter('');
                }
            });
        });
    </script>
