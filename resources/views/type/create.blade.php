<form id="form_type" class="form-horizontal" role="form" method="POST"
    action="{{ isset($type) ? url('type/' . $id) : url('type') }}">
    {!! csrf_field() !!}
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <p class="small">Create a new or edit type using this form, make sure you fill them all</p>
            <div class="row top">
                <div class="col-sm-12">
