                ...
                <div class="col-sm-12">
                    <div class="form-group form-group-default">
                        ...
                        <select class="form-control" id="category" name="category">
                            <option value="0"
                                {{ isset($manage_user) && $manage_user->category == 0 ? 'selected' : '' }}>Admin
                            </option>
                            <option value="1"
                                {{ isset($manage_user) && $manage_user->category == 1 ? 'selected' : '' }}>TPS
                            </option>
                            <option value="2"
                                {{ isset($manage_user) && $manage_user->category == 2 ? 'selected' : '' }}>
                                Bahasa Inggris </option>
                            <option value="3"
                                {{ isset($manage_user) && $manage_user->category == 3 ? 'selected' : '' }}>
                                TPA </option>
                        </select>
                    </div>
                </div>
