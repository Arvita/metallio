<form id="deleteMenuForm" class="form-horizontal" role="form" method="POST" action="#">
    {!! csrf_field() !!}
    {!! isset($schedule) ? method_field('DELETE') : '' !!}
    {!! Form::hidden('id', $id) !!}
    ...
    <div class="swal-content">
        ...
        <div class="swal-text top">
            <p>Are your sure you want to delete this schedule?</p>
            <p><strong><em>"{{ $schedule->name }} "</em></strong></p>
        </div>
    </div>
    <!-- </div> -->
