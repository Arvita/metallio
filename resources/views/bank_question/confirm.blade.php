<form id="deleteMenuForm" class="form-horizontal" role="form" method="POST" action="#">
    {!! csrf_field() !!}
    {!! isset($bank_question) ? method_field('DELETE') : '' !!}
    {!! Form::hidden('id', $id) !!}
    ...
    <div class="swal-content">
        ...
        <div class="swal-text top">
            <p>Are your sure you want to delete this bank question?</p>
            <p><strong><em>"{{ $bank_question->name }} "</em></strong></p>
        </div>
    </div>
    <!-- </div> -->
