    ...
    (d.prototype = {
            ...
            this.$element.parent().hasClass("bootstrap-timepicker")
                ? (this.$element
                  ...
                  this.$element.on({
                      ...
                      "mousewheel.timepicker DOMMouseScroll.timepicker":
                          a.proxy(this.mousewheel, this),
                  }))
                : this.template
                ? this.$element.on({
            ...
            switch (a.which) {
                case 9:
                    if (a.shiftKey) {
                        ...
                        if (
                            (this.showMeridian &&
                                "meridian" === this.highlightedUnit) ||
                            (this.showSeconds &&
                                "second" === this.highlightedUnit) ||
                            (!this.showMeridian &&
                                !this.showSeconds &&
        ...
        getCursorPosition: function () {
            ...
            if (c.selection) {
                ...
                return (
                    b.moveStart("character", -a.value.length), b.text.length - d
                );
            }
        },
        ...
        setDefaultTime: function (a) {
            if (this.$element.val()) this.updateFromElementVal();
                ...
                0 !== e &&
                    ((e =
                        Math.ceil(b.getSeconds() / this.secondStep) *
                        this.secondStep),
                    60 === e && ((d += 1), (e = 0))),
                    0 !== d &&
                        ((d =
                            Math.ceil(b.getMinutes() / this.minuteStep) *
                            this.minuteStep),
                        60 === d && ((c += 1), (d = 0))),
                    this.showMeridian &&
                        (0 === c
        ...
        setTime: function (a, b) {
            ...
            if ("object" == typeof a && a.getMonth)
                ...
                if (
                    ((c = (/a/i.test(a) ? 1 : 0) + (/p/i.test(a) ? 2 : 0)),
                    c > 2)
                )
            ...
            (this.hour = e),
                this.snapToStep
                    ? ((this.minute = this.changeToNearestStep(
                          f,
                          this.minuteStep
                      )),
                      (this.second = this.changeToNearestStep(
                          g,
                          this.secondStep
                      )))
        ...
        updateWidget: function () {
            if (this.$widget !== !1) {
                ...
                this.showInputs
                    ? (this.$widget
                          .find("input.bootstrap-timepicker-hour")
                          .val(a),
                      this.$widget
                          .find("input.bootstrap-timepicker-minute")
                          .val(b),
                      this.showSeconds &&
                          this.$widget
                              .find("input.bootstrap-timepicker-second")
                              .val(c),
                      this.showMeridian &&
                          this.$widget
                              ...
                              .val(this.meridian))
                    : (this.$widget
                          .find("span.bootstrap-timepicker-hour")
                          .text(a),
                      this.$widget
                          .find("span.bootstrap-timepicker-minute")
                          .text(b),
                      this.showSeconds &&
                          this.$widget
                              .find("span.bootstrap-timepicker-second")
                              .text(c),
                      this.showMeridian &&
                          this.$widget
